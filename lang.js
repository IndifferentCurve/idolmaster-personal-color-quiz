...
window.translations = {
  ko: {
    ...
    customSelectVisible: "현재 시리즈 전체 선택",
    customClearVisible: "현재 시리즈 해제",
    customReset: "전체 리셋",
  ...
  jp: {
    ...
    customSelectVisible: "表示中を全選択",
    customClearVisible: "表示中を解除",
    customReset: "全リセット",
  ...
  en: {
    ...
    customSelectVisible: "Select Current Series",
    customClearVisible: "Clear Current Series",
